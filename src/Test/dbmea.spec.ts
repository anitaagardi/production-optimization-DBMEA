...
import { looseSegmentMutation } from "../DBMEA/Operators/Bacterial_Mutation/looseSegmentMutation";
import { geneTransfer } from "../DBMEA/Operators/Gene_Transfer/geneTransfer";
